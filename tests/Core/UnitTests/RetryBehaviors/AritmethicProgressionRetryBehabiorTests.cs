...
{
    public class ArithmeticProgressionRetryBehaviorTests
    {
        [Theory]
        [InlineData(1, 1, 1, 1)]
        [InlineData(1, 5, 1, 5)]
        ...
        public void GivenRetryBehaviorWhenAttemptShouldCalculateDelay(
            ...
            int delay)
        {
            var behavior = new ArithmeticProgressionRetryBehavior(coeficient, initialValue);
        ...
        {
            var behavior = new ArithmeticProgressionRetryBehavior(1, 1);
